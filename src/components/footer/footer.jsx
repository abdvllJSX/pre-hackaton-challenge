        ...
        <footer>
            <div className="footer-top">
                <div className="coll-1">
                    <h3 className="sub-header">get <span className="green">linked</span></h3>
                    <p className="paragraphs coll-1__paragraph">
                        Getlinked Tech  is a technology innovation
                        program<br></br>established by a group with the aim
                        of showcasing<br></br>young individuals in the field
                        of technology
                    </p>

                    <p className="paragraphs">Terms of Use <span className="green">|</span> privacy Policy</p>
                </div>
