        ...
        <footer>
            <div className="footer-top">
                <div className="coll-1">
                    <h3 className="sub-header coll-1__header">get <span className="green">linked</span></h3>
                    <p className="paragraphs coll-1__paragraph">
                        Getlinked Tech  is a technology innovation
                        program established by a group with the aim
                        of showcasing young individuals in the field
                        of technology
                    </p>

                    <p className="paragraphs coll-1__paragraph2">Terms of Use <span className="green">|</span> privacy Policy</p>
                </div>

                <div className="coll-2">
                    <ul>
                        <li className="green" style={{ fontWeight: "600" }}>Useful Links</li>
                        <li>Overview</li>
                        <li>Timeline</li>
                        <li>FAQS</li>
                        <li>Register</li>
                        <li><span className="green">Follow us </span>
                            <span>
                            ...
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon" width="19" height="17" viewBox="0 0 19 17" fill="none">
                            ...
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon" width="11" height="20" viewBox="0 0 11 20" fill="none">
                ...
                <div className="coll-3">
                    <p className="green" style={{ fontWeight: "600" }}>Contact Us</p>
                    ...
                    <div className="contact">
                        ...
                        <p className="address">27,Alara Street
                            Yaba 100012
                            Lagos State</p>
                    </div>
                </div>
