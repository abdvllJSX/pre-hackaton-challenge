...
export default function Contact() {
    return (
        <div className="register-container">
            ...
            <div className="r-f2"></div>
            <main className="register">
                <div className="register-left">
                    <h3 className="sub-header register-left__header"><span className="green">Get in touch</span></h3>
                    <p className="paragaphs register-left__paragraph1">Contact Information</p>
                    <p className="paragaphs register-left__paragraph2">27,Alara Street Yaba 100012 Lagos State</p>
                    <p className="paragraphs register-left__paragraph3">Call Us : 07067981819</p>
                    <p className="paragraphs register-left__paragraph4">we are open from Monday-Friday 08:00am - 05:00pm</p>
                    <p className="paragraphs register-left__paragraph5"> <span className="green">Share on</span></p>
                    <div className="register-left__icons">
                        ...
                        <svg  className="icon" xmlns="http://www.w3.org/2000/svg" width="19" height="17" viewBox="0 0 19 17" fill="none">
                        ...
                        <svg className="icon" xmlns="http://www.w3.org/2000/svg" width="11" height="20" viewBox="0 0 11 20" fill="none">
                ...
                <div className="register__right">
                    <form action="" className="form">
                        <h3 className="sub-header form-header"><span className="green">Questions or need assistance?</span></h3>
                        <h3 className="sub-header form-header form-header2"><span className="green">Let us know  about it!</span></h3>
                        <div className="input">
                            <input type="text" className="inputs" placeholder="First Name" />
                        </div>
                        <div className="input">
                            <input type="text" className="inputs" placeholder="Mail" />
                        </div>

                        <div className="message">
                            <textarea name="message-input" id="" cols="30" rows="10" placeholder="Message"></textarea>
                        </div>
